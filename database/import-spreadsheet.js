 ...
 * Matches your exact column structure:
 * - Number
 * - Konkani Word in Devnagiri  
 * - Konkani word in English alphabet
 * - English Meaning
 * - Context/usage in a sentence
 * - Does the Devnagiri Spelling need correction? (Y/N)
 * - Does the meaning need correction? (Y/N)
 * - Corrected Devnagiri Spelling by user X
 * - Corrected Devnagiri Spelling by user Y
 * - Corrected English meaning by user X
 * - Corrected English meaning by user Y
 */
        ...
        .on('end', async () => {
          ...
          for (const row of results) {
            try {
              ...
              // Skip empty rows
              if (!entryData.word_konkani_english_alphabet && !entryData.english_meaning) {
                continue;
              }
              ...
              console.error(`❌ Error importing row ${row.entry_number}:`, error.message);
              errorCount++;
            }
          }
